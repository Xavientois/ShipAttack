...
public class MainGame extends JPanel implements Runnable, KeyListener{
    ...
    public static final String NAME  = "Game";  //Name of JFrame
    ...
    /**Does all the painting of graphics*/
        ...
        if(running){
            ...
            if(help){
                ...
                for(int i = 0; i < instructions.length; i++){
                    text = instructions[i];
                    g2.drawString(text ,WIDTH/2 - 100, HEIGHT/2 + (i * 30));
                }
            }
